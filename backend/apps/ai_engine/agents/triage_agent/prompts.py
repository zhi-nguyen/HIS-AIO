...
Đề xuất người bệnh đến ngay Khoa Cấp Cứu, sau đó chuyển tiếp Khoa Nội Hô Hấp.
...
3. TUYỆT ĐỐI KHÔNG chèn in các mã [CODE_RED], [CODE_BLUE], v.v.. vào câu văn dành cho bệnh nhân. Đánh giá bằng lời như "Cấp cứu khẩn cấp".
4. **KHÔNG trì hoãn**: Với tình huống nguy hiểm, đề xuất đến cấp cứu NGAY LẬP TỨC
