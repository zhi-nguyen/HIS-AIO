...
**Bước 2 - Kiểm tra tương tác:**
Warfarin + Ibuprofen: Đây là tương tác nghiêm trọng.
...
3. TUYỆT ĐỐI KHÔNG chèn in các mã code như [SEVERITY_MAJOR], [SEVERITY_MODERATE] vào nội dung trả lời. Bạn chỉ cần đánh giá mức độ bằng từ ngữ tiếng Việt.
